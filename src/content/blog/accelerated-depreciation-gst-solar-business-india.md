---
title: "Accelerated Depreciation & GST Benefits on Solar — A Complete Guide for Business Owners in India"
description: "Most business owners buying solar miss out on a 40% Accelerated Depreciation benefit that cuts their effective system cost by 10–12 lakhs on a ₹20 lakh installation. Here's exactly how it works."
date: "2026-04-06"
category: "Commercial Solar"
image: ../../assets/blog/solar-tax-benefits-india.jpg
author: "Techedge Team"
tags: ["accelerated depreciation solar", "solar tax benefits India", "GST input credit solar", "commercial solar India", "solar ROI India", "Section 32 income tax", "solar for business"]
---
...
1. Ensure your solar system is **capitalised as a fixed asset** in your books under "Plant & Machinery — Renewable Energy Devices"
2. Apply 40% depreciation under the WDV method starting the year of commissioning
3. If installation happens mid-year, first-year depreciation is prorated at 50% (i.e., 20% of asset value) if put to use for less than 180 days — full 40% if used for 180+ days
4. Your CA will claim this in your **ITR-6** (companies) or **ITR-3/5** (firms/proprietors)

### For GST Input Tax Credit

1. Ensure your EPC contractor raises a **proper GST tax invoice** with HSN codes and your GSTIN
2. Verify that the invoice appears in **GSTR-2B** (auto-populated from supplier's GSTR-1)
3. Claim the ITC in your **GSTR-3B** in the month you receive the invoice and goods
4. Maintain documentation: invoice, commissioning certificate, asset register entry
...
**Mistake 1: Treating solar as an expense, not an asset**
Some accountants book the solar installation as a maintenance expense rather than capitalising it. This means you get a one-time deduction but lose the AD benefit in subsequent years. Always capitalise.

**Mistake 2: Missing the 180-day rule**
If your solar system is commissioned after September 30, you can only claim 50% of the AD in that financial year (20% of asset value instead of 40%). Plan commissioning before October for maximum Year 1 benefit.

**Mistake 3: Not providing GSTIN to EPC at the time of order**
Your GST number must appear on the tax invoice for ITC to be claimable. Some customers forget to share it at the order stage and receive a B2C invoice — which cannot be used for ITC.

**Mistake 4: Assuming ITC is automatic**
ITC is only claimable if your supplier (EPC company) has filed their GSTR-1. Always verify in GSTR-2B before claiming.
...
- See a live example: [HPCL Shri Durgha Fuels, Bengaluru →](/projects/hpcl-shri-durgha-fuels)
...
- AIF Interest Subvention also available — [read more →](/blog/aif-interest-subvention-cold-storage-solar)
